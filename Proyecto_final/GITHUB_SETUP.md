...
Después de crear el repositorio, GitHub te mostrará comandos. Reemplaza `tunombre` con tu usuario de GitHub y copia estos comandos en PowerShell:

```bash
git remote add origin https://github.com/tunombre/proyecto-16-semanas.git
git branch -M main
...
Tu sitio estará en: `https://josueherrerabastidas7.github.io/proyecto-16-semanas/`
...
git remote set-url origin https://github.com/tunombre/proyecto-16-semanas.git
```
...
```bash
git remote set-url origin https://tu_token@github.com/tunombre/proyecto-16-semanas.git
```
